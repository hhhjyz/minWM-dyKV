...
CASES="${CASES:-baseline,retrieval_no_compression,retrieval_no_compression_relevance_order,worldkv_pose_no_compression,yaw_intrinsics,packed_chunks,packed_chunks_latent,retr8_compression_r050,retr12_compression_r050,retr16_r033_slot_packed,retr16_compression_r033,motion_novelty_sphere_unfilled,motion_novelty_slot_capped,motion_novelty_unfilled,motion_novelty_backfill,motion_novelty_duplicate}"
