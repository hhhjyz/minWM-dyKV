...
CASES="${CASES:-baseline,retrieval_no_compression,worldkv_pose_no_compression,yaw_intrinsics,packed_chunks,packed_chunks_latent,retr8_compression_r050,retr12_compression_r050,retr16_compression_r033}"
