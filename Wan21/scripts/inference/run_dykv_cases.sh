...
CASES="${CASES:-baseline,retrieval_no_compression,worldkv_pose_no_compression,fixed_novelty,yaw_intrinsics,packed_chunks,packed_chunks_latent,predecessor_chunks,predecessor_chunks_latent,predecessor_query_backfill,retr8_compression_r050,retr12_compression_r050,retr16_compression_r033}"
