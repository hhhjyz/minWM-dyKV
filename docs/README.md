...
- [`MOTION_ADAPTIVE_NOVELTY_COMPRESSION.md`](MOTION_ADAPTIVE_NOVELTY_COMPRESSION.md)：连续 FOV 保留比例、WorldKV novelty 选择，以及 capped、欠填、唯一 token 补回和重复 token 消融；capped 与欠填 case 已实现注册；
